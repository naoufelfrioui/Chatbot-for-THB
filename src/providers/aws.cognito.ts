...
// declare const aws_cognito_region  ='us-east-1';
// declare const aws_cognito_identity_pool_id =;
// declare const aws_user_pools_id;
// declare const aws_user_pools_web_client_id ='mobilehubproject_userpoolapp_MOBILEHUB_845328772 web';
...
export class Cognito {
  ...
  constructor(public config: Config) {
    ...
    AWSCognito.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1_UWu6kChdE'
    });
  ...
  getUserPool() {
    return new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool({
      "UserPoolId": 'us-east-1_UWu6kChdE',
      "ClientId": '2sq9q82koe6hcudn125vnfj03u'
    });
  }
